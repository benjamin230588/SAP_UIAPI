...
Namespace BenjaADDON
    Public Class Menu
        ...
        Sub AddMenuItems()
            ...
            oCreationPackage.UniqueID = "BenjaADDON"
            oCreationPackage.String = "BenjaADDON"
            ...
            Try
                ...
                oMenuItem = Application.SBO_Application.Menus.Item("BenjaADDON")
                oMenus = oMenuItem.SubMenus

                'Create s sub menu
                oCreationPackage.Type = SAPbouiCOM.BoMenuType.mt_STRING
                oCreationPackage.UniqueID = "BenjaADDON.Form1"
        ...
        Sub SBO_Application_MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean) Handles SBO_Application.MenuEvent
            ...
            Try
                If (pVal.BeforeAction And pVal.MenuUID = "BenjaADDON.Form1") Then
